<template>
    <header class="z-40" :class="{ dark: store.semidark && store.menu === 'horizontal' }">
        <div class="shadow-sm">
            <!-- 상단 영역1(로고,알림,프로필아이콘등..) -->
            <div class="relative bg-white flex w-full items-center px-5 py-2.5 dark:bg-[#0e1726]" style="">
                ...
                <div style="border: 0px solid red; width:70%; justify-content: center; display: flex;">
                    <!--H2 class="lg:hidden">HANEX TMS - MOBILE</h2 -->
                    <img src="/assets/images/hanex/HanExpress_CI_02.png" style="height:2rem; width:auto;"/>
                </div>
                <div
                                ...
                                <ul class="text-dark dark:text-white-dark !py-0 w-[230px] font-semibold dark:text-white-light/90">
                                    <li>
                                        <div class="flex items-center px-4 py-4">
                                            <div class="flex-none">
                                                <img class="rounded-md w-10 h-10 object-cover" src="/assets/images/hanex/HanExpress_CI_02.png" alt="" />
                                            </div>
                                            <div class="ltr:pl-4 rtl:pr-4 truncate">
                                                <h4 class="text-base">
                                                    경기88아7722<span class="text-xs bg-success-light rounded text-success px-1 ltr:ml-2 rtl:ml-2">Pro</span>
                                                </h4>
